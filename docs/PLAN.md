...
> เอกสารรวมสถานะ + userflow + ปัญหาที่เจอ: [`OVERVIEW.md`](OVERVIEW.md) (v1.6)
...
| 5 ประเภทเอกสารเพิ่ม | คำสั่ง ✅ · ประกาศ ✅ · รับรอง ✅ · รายงานการประชุม ✅ · **ถัดไป: ระเบียบ/แถลงการณ์** | 🔄 กำลังทำ |
| 6 Billing จริง | เปิด Stripe env + conversion | 🔄 โครงโค้ดพร้อม / ยังไม่เปิดขาย |

**ชิ้นงานถัดไปที่ล็อก:** ระเบียบ (แบบที่ 5)
...
| 4 | หนังสือสั่งการ | ✅ คำสั่ง | `ORDER` (ระเบียบ/ข้อบังคับ เลื่อน) |
| 5 | หนังสือประชาสัมพันธ์ | ✅ ประกาศ | `ANNOUNCE` (แถลงการณ์/ข่าว เลื่อน) |
| 6 | หนังสือรับรอง | ✅ | `CERT` · แบบที่ 10 |
| 7 | รายงานการประชุม | ✅ | `MEETING` · แบบที่ 11 · กรอบโลโกว่าง ไม่มีครุฑ |
