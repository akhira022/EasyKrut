...
**อัปเดต:** 9 ส.ค. 2026 · คู่กับ OVERVIEW / PLAN **v1.3**  
ตรงกับโค้ด: หนังสือภายนอก + ภายใน, เทมเพลต, invite, Stripe (เมื่อตั้ง env), จุดสร้าง `/documents/new`
...
4. กด **สร้างเอกสาร** → `/documents/new` เลือก **ภายนอก** หรือ **ภายใน**
...
| เลือกประเภท | ภายนอก / ภายใน | อื่นๆ = “เร็วๆ นี้” (ชิ้นถัดไป: ประทับตรา) |
