...
อัปเดตล่าสุดให้สอดคล้องกับโค้ดที่รองรับหนังสือภายนอก + ภายใน, เทมเพลตหน่วยงาน, invite, และ Stripe (เมื่อตั้งค่า env)

> ภาพรวมทั้งระบบอยู่ที่ [`OVERVIEW.md`](OVERVIEW.md)
