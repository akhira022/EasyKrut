...
**เวอร์ชัน:** 1.5  
**สถานะเอกสาร:** ตรงกับโค้ดบน `cursor/memo-underline-layout-efc5` (14 ส.ค. 2026)
...
**อัปเดตล่าสุด:** Version 1.5 — เส้นคั่นบันทึกข้อความตามแบบกระดาษ · แก้เอกสารรายงานการประชุมให้ตรงระเบียบ (แบบที่ 11 แยกจากหนังสือรับรอง)
...
| สั่งการ / ประชาสัมพันธ์ / รับรอง / รายงานการประชุม | ⏳ | “เร็วๆ นี้” ใน UI — แยกการ์ดรับรองกับรายงานการประชุม |
...
**รายงานการประชุมยังไม่เปิดใน editor** — มีแค่ชนิดใน constants + ป้าย UI  
ชื่อทางการคือ **รายงานการประชุม** (ไม่ใช่ “บันทึกการประชุม” / “ประชุม”) ตามระเบียบข้อ 25 และแบบที่ 11 ท้ายระเบียบ

หัวข้อที่ต้องมีเมื่อทำชนิดนี้:
...
1. สั่งการ (คำสั่ง)  
2. ประชาสัมพันธ์  
3. หนังสือรับรอง (แบบที่ 10)  
4. รายงานการประชุม (แบบที่ 11) 
